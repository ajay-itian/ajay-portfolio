    ...
    <section id="contact" className="contact">
      ...
      <div className="contact-links">
        <a href="https://www.linkedin.com/in/ajay-patmas123/" target="_blank" rel="noopener noreferrer" className="contact-link">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="contact-logo linkedin-logo">
        ...
        <a href="https://github.com/ajay-itian" target="_blank" rel="noopener noreferrer" className="contact-link">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0  24 24" width="24" height="24" className="contact-logo github-logo">
        ...
        <a href="mailto:ajaypatmas1000@gmail.com" className="contact-link">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="contact-logo email-logo">
